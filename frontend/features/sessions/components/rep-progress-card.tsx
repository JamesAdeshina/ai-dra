...
export function RepProgressCard({
  ...
  return (
    <Card className="h-[158px] rounded-2xl border-0 bg-white p-3 shadow-none">
      <h2 className="text-[20px] font-semibold leading-[150%] text-[#1E1E1E]">
        Rep Progress
      </h2>

      <div className="mt-1 flex rounded-full bg-[#FAFAFA] p-[1px]">
      ...
      <p className="mt-1 text-[32px] font-semibold leading-[120%] text-[#111111]">
        {safeCurrentRep}

...
import { adminNavigationItems } from "@/features/admin/data/admin-navigation";
...
export function AdminSidebar({ onNavigate }: AdminSidebarProps) {
  ...
  return (
    <>
      <aside className="flex h-full min-h-screen flex-col border-r border-[#E9E5E1] bg-[#F8F6F4] px-6 py-7">
        <Link
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-[#7C7672]">
              Admin / Research Portal
            </p>
          </div>
        </Link>

        <nav className="mt-10 flex-1" aria-label="Admin portal navigation">

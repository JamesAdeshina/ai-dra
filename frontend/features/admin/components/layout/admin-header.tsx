...
const pageDetails = [
  {
    ...
    title: "Dashboard",
    description: "Monitor platform engagement and rehabilitation activity.",
  },
  {
    route: "/admin/survivors",
    title: "Survivors",
    description: "Review survivor engagement, activity and support status.",
  },
  {
    route: "/admin/carers",
    title: "Carers",
    description: "Monitor carer accounts and survivor connections.",
  },
  {
    route: "/admin/invitations",
    title: "Invitations",
    description: "Review survivor and carer invitation activity.",
  },
  {
    route: "/admin/sessions",
    title: "Sessions",
    description: "Review rehabilitation sessions across the platform.",
  },
  {
    route: "/admin/exercises",
    title: "Exercises",
    description: "Manage and review the shared rehabilitation catalogue.",
  },
  {
    route: "/admin/analytics",
    title: "Analytics",
    description: "Explore planned engagement and research analytics.",
  },
  {
    route: "/admin/notifications",
    title: "Notifications",
    description: "Review platform events and monitoring alerts.",
  },
  {
    route: "/admin/settings",
    title: "Settings",
    description: "Manage administrator and platform preferences.",
  },
];
...
export function AdminHeader({ onOpenNavigation }: AdminHeaderProps) {
  ...
  const currentPage =
    pageDetails.find((page) => pathname.startsWith(page.route)) ??
    pageDetails[0];
  ...
  const email = profile?.email?.trim() || "admin@ai-dra.co.uk";
      ...
      <header className="sticky top-0 z-40 flex min-h-[94px] items-center justify-between border-b border-[#ECE9E6] bg-white px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Link
            ...
            className="relative flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F1EF] text-[#67615D] transition hover:bg-[#EAE6E2]"
          >
            <Bell size={19} />

            <span
              aria-hidden="true"
              className="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-[#F23636]"
            />
          </Link>

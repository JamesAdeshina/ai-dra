...
export function ExerciseListItem({
  ...
  return (
    <Link
      ...
      className="group block rounded-2xl focus:outline-none focus-visible:ring-4 focus-visible:ring-[#592EBD]/25"
    >
      <Card className="grid cursor-pointer grid-cols-1 gap-5 rounded-2xl border-0 bg-white p-4 shadow-none transition duration-200 hover:-translate-y-0.5 hover:shadow-sm lg:grid-cols-[112px_minmax(0,1fr)_180px_160px_48px] lg:items-center lg:gap-6">
        ...
        <div
          aria-hidden="true"
          className="flex h-12 w-12 items-center justify-center rounded-full bg-neutral-100 text-neutral-700 transition group-hover:bg-[#592EBD] group-hover:text-white"
        >
